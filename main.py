...
def option_1():
    ...
    n_c=load_client(n_c,na,sna,s_t,s_p,nu_clie)
...
def option_2(list_c):
    ...
    while opc3==1:
        ...
        if opc4 ==1:
            ...
            data=browser_client(list_c,aux1,aux2,aux3)
...
while opc == 1:
    ...
    opc=int(input("desea realizar otra operacion \nSI(1)\nNO(0)\n"))
